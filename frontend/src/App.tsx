...
import { LockKeyhole, ShieldCheck, Video, LifeBuoy, ArrowRight, CheckCircle, Users, Globe, Zap, MessageSquare } from "lucide-react";
...
function App() {
  const cardItems = [
    {
      ...
      desc: "Funds are held securely until both parties confirm the trade.",
  ...
  const steps = [
    { number: "01", title: "List or Choose", desc: "Sellers list accounts with full details. Buyers browse verified listings.", icon: Globe },
    { number: "02", title: "Secure Escrow", desc: "Payments are safely held until account transfer is complete.", icon: LockKeyhole },
    { number: "03", title: "Confirm & Complete", desc: "Both parties confirm before funds are released.", icon: CheckCircle }
  ];

  const securityFeatures = [
    { title: "Account Verification", desc: "Sellers provide proof of ownership to reduce fraud.", icon: ShieldCheck },
    { title: "Protected Transactions", desc: "Escrow protection ensures fair trades and prevents chargebacks.", icon: LockKeyhole },
    { title: "Dispute Resolution", desc: "Our team reviews disputes for fair outcomes.", icon: MessageSquare },
    { title: "24/7 Monitoring", desc: "Continuous system monitoring for suspicious activities.", icon: Zap },
    { title: "Identity Verification", desc: "Multi-factor authentication for all users.", icon: Users },
    { title: "Global Protection", desc: "Secure transactions across all regions.", icon: Globe }
  ];
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-gray-50 to-white">
      ...
      {/* HERO SECTION */}
      <section id="home" className="relative overflow-hidden bg-linear-to-br from-indigo-900 via-indigo-800 to-violet-900 text-white py-24 px-4">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            Trade Your <span className="text-transparent bg-clip-text bg-linear-to-r from-amber-300 to-orange-400">Accounts</span><br />Safely & Securely
          </h1>
          
          <p className="text-xl md:text-2xl max-w-3xl mx-auto opacity-90 mb-10">
            TradeRoof is a secure escrow platform for buying and selling PC game accounts without the risk.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {cardItems.map((item, index) => (
              ...
              >
                <div className={`absolute top-0 left-0 right-0 h-1 bg-linear-to-r ${item.gradient} rounded-t-2xl`} />
                <div className={`inline-flex p-3 rounded-xl bg-linear-to-br ${item.gradient} mb-6`}>
      ...
      {/* HOW IT WORKS */}
      <section id="how-it-works" className="bg-linear-to-b from-white to-gray-50 py-20 px-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center">
                {["99.8%", "10K+", "24/7", "50+"].map((stat, index) => (
                  <div key={index} className="text-center">
                    <div className="text-3xl font-bold text-indigo-700 mb-2">{stat}</div>
      ...
      {/* SUPPORT */}
      <section id="support" className="bg-linear-to-br from-gray-900 to-indigo-950 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto mb-10">
            Whether you have questions about trades, account verification, or technical issues, TradeRoof support is here to guide you every step of the way.
          </p>
      ...
      <section id="cta" className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center bg-linear-to-r from-indigo-600 to-violet-600 rounded-3xl p-12">
          ...
          <p className="text-indigo-100 text-lg mb-8 max-w-2xl mx-auto">
            Join thousands of traders who trust TradeRoof for safe account trading
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
